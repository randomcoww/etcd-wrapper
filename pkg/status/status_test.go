...
// 	mockClient
// 	// New(e []string, tlsConfig *tls.Config) (*mockClient, error)
// }
...
// func (v *mockStatus) New(e []string, tlsConfig *tls.Config) (*mockClient, error) {
// 	return &mockClient{
// 		endpoints: e,
// 	}, nil
// }
...
// func (v *mockClient) SetEndpoints(e ...string) {
// 	v.endpoints = []string{}
// 	v.endpoints = append(v.endpoints, e)
// }

// func (v *mockClient) Endpoints() []string {
// 	return v.endpoints
// }

// func (v *mockClient) Close() {
// }

// func (v *mockClient) Status(handler func(*etcdutil.StatusResp, error)) error {
...
// func (v *mockClient) ListMembers() ([]*etcdutil.MemberResp, error) {
// 	v.healthCheckEndpoints = v.endpoints
// 	return v.listMembersResponse, v.listMembersError
// }

// func (v *mockClient) HealthCheck() error {
// 	v.listMembersEndpoints = v.endpoints
